    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="nav-item {{ request()->routeIs('admin.notifikasi') ? 'active' : '' }}">
                <a href="{{ route('admin.notifikasi') }}" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="nav-item {{ request()->routeIs('admin.lokasi-mall') ? 'active' : '' }}">
                <a href="{{ route('admin.lokasi-mall') }}" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="nav-item {{ request()->routeIs('admin.parkiran') ? 'active' : '' }}">
                <a href="{{ route('admin.parkiran') }}" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
