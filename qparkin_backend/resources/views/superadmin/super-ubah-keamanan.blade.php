...
<div class="security-container">
    ...
    <div class="security-content">
        <div class="security-section">
            ...
            <form class="security-form" id="changePasswordForm" method="POST" action="{{ route('superadmin.profile.update') }}">
                @csrf
            ...
            <div class="activity-list">
                <div class="activity-item">
                    ...
                    <div class="activity-details">
                        ...
                        <p class="activity-time">{{ now()->translatedFormat('d F Y, H:i') }} WIB</p>
                        <p class="activity-device">Windows • Chrome</p>
                    </div>
                </div>
            </div>
        </div>
