...
<body class="bg-gradient-animated min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="floating-element w-48 h-48 bg-blue-300 rounded-full bottom-20 left-10 animate-bounce-gentle"
        ...
        <h1 class="text-7xl text-white font-bold mb-4">429</h1>
        <h2 class="text-3xl text-white font-semibold mb-4">Terlalu Banyak Permintaan</h2>
        <p class="text-gray-200 mb-6">Anda telah melakukan terlalu banyak permintaan. Silakan coba lagi nanti.</p>
