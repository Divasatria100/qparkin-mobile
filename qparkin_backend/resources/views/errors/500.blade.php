...
<body class="bg-gradient-animated min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="p-8 text-center max-w-md">
        <h1 class="text-7xl font-bold text-white mb-4">500</h1>
        <h2 class="text-3xl font-semibold text-white mb-4">Kesalahan Server</h2>
        <p class="text-gray-200 mb-6">Terjadi kesalahan pada server. Silakan coba lagi nanti.</p>
        <div class="space-y-3">
            <button onclick="window.location.reload()" class="bg-gradient-to-r bg-white/30 hover:bg-blue-700 text-white font-bold py-3 px-5 rounded-xl">
                Coba Lagi
            </button>
            <a href="{{ url('/') }}" class="bg-gradient-to-r bg-white/30 hover:bg-blue-700 text-white font-bold py-3 px-5 rounded-xl">
                Ke Dashboard
            </a>
            <a href="mailto:support@qparkin.com" class="block text-gray-200 hover:text-white font-bold ">
                Hubungi Support
            </a>
        </div>
    </div>
