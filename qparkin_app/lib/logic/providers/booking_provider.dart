...
class BookingProvider extends ChangeNotifier {
  ...
  double get pointReduction => _pointReduction;

  // Computed properties
  double get finalCost {
    final reduced = _estimatedCost - _pointReduction;
  ...
  /// Set points to use for payment
  ///
  /// Requirements: 6.2, 6.3
  void setPointsToUse(int points, {double pointConversionRate = 10.0}) {
    debugPrint('[BookingProvider] Setting points to use: $points');
    
    _pointsToUse = points;
    _pointReduction = points * pointConversionRate;
    
    debugPrint('[BookingProvider] Point reduction: Rp $_pointReduction');
    notifyListeners();
  }

  /// Clear point usage
  void clearPointUsage() {
    _pointsToUse = 0;
    _pointReduction = 0.0;
    notifyListeners();
  }
