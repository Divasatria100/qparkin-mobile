            ...
            child: Column(
              ...
              Column(
                children: [
                  ...
                  // Point reduction if applicable
                  if (pointsUsed != null && pointsUsed! > 0 && pointReduction != null) ...[
                    const SizedBox(height: 8),
                    Semantics(
                      label: 'Potongan poin ${_formatCurrency(pointReduction!)}',
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Flexible(
                          ...
                          Flexible(
                            child: Text(
                              '- ${_formatCurrency(pointReduction!)}',
                              style: TextStyle(
                                fontSize: bodyFontSize,
                                fontWeight: FontWeight.w600,
                                color: const Color(0xFF4CAF50),
                  ...
                  // Final total
                  Semantics(
                    label: 'Total bayar ${_formatCurrency(totalCost - (pointReduction ?? 0))}',
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Flexible(
                        ...
                        Flexible(
                          child: Text(
                            _formatCurrency(totalCost - (pointReduction ?? 0)),
                            style: TextStyle(
