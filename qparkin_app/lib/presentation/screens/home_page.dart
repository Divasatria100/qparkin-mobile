...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    _loadData();
    _initializePointData();
  }

  /// Initialize point data on page load
  ///
  /// Fetches the current point balance to ensure the card displays
  /// accurate information and initializes the notification system.
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 16),
                      // Premium Points Card with badge indicator
